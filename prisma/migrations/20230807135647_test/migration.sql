/*
  ...
  - Added the required column `preferenes` to the `User` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `User` DROP PRIMARY KEY,
    ...
    ADD COLUMN `preferenes` JSON NOT NULL,
